...
#       ၀.၉၂ (= အောက်ခြေမှ ၈%) ထားသည် — QC `cap_max` ၀.၉၃ အောက်。
 ...
 # ⚠️ **ဂရပ်ဖစ် စာချုပ်** — `motionkit/IKKI_GRAPHIC_CREATOR.md`
 #    (Zin ၂၀၂၆-၀၉-၂၅: 「ဒါကို Short Video edit style မှာ ထည့်ပေးပါ」)。
 #    template အသစ် ဆောက်သူက အဲဒီ §၃–§၆ ကို လိုက်နာရမည် — manifest ·
 ...
 "short-video": dict(label="ZAE Short", theme="zae", fps=30,
    ...
    # ⚠️ **ဂရပ်ဖစ်တိုင်း အသံ ရရမည်** (Zin ၂၀၂၆-၀၉-၂၅: 「Sound Effect နဲ့
    #    graphic ထွက်တဲ့အချိန်နဲ့ ကွက်တိဖြစ်အောင်」)。 `dress.sfx()` က
    #    ဂရပ်ဖစ်တစ်ခုချင်းအတွက် `at−0.22s` (ရှေ့သံ) + `at` (ထပ်သံ) ထည့်သဖြင့်
    #    **အချိန်က ကွက်တိ ဖြစ်ပြီးသား** — ပြဿနာက **ဖုံးအုပ်မှု**。
    # ⚠️ `0.9` ဆိုလျှင် ၇၂s မှာ အခိုက် **၁ ခု**သာ ခွင့်ပြုသဖြင့် ဂရပ်ဖစ် ၆ ခုမှာ
    #    ၅ ခုက **အသံ ပြုတ်**ခဲ့သည် (j_69f298f1a97f: SFX ၂ cue ၂ ခုလုံး
    #    ပထမ ၁ စက္ကန့်ထဲ · B-roll ဖြတ်ချက် ၆ ခု တစ်ခုမှ မတိုက်)。
    # ⚠️ ဂရပ်ဖစ် ~၅–၈/မိနစ် ⇒ `6.0` (headtop နဲ့ တူ) ထားသည် — ဂိတ်က
    #    `sfx_density ≤ per_min` ဖြစ်၍ ထုတ်သူနဲ့ ဂိတ် **အတူတူ တက်**သည်。
    # ⚠️ ယခင် `0.9` က QC ရဲ့ REF စာကြောင်း (0.6/1.1 SFX/min) ကနေ လာသည် —
    #    အဲဒီ တိုင်းချက်က **မှားသော မျိုးရိုး**ဖြစ်ကြောင်း ၂၀၂၆-၀၉-၂၅ မှာ
    #    အတည်ပြုပြီး ([[ikki-eleven-references]]) ⇒ အခြေခံ အဖြစ် မသုံးရ。
    # ⚠️ **၆.၀ မထားရ** — `SFX_CEIL = 1.5` (= `qc.SFX_MAX_PER_MIN`) ကို
    #    ချိုးသဖြင့် `tests/test_motionlv.py` က ဖမ်းမိသည် (မှန်သည်)。
    #    ဂိတ် ကျော်ခွင့်ရှိတာ `sfxpol.MEASURED` တစ်ခုတည်း ဖြစ်ပြီး အဲဒီမှာ
    #    **တိုင်းချက် `src` မှတ်ရ**သည် — ZAE အတွက် တိုင်းချက် **မရှိ**ပါ
    #    (SFX ကို ၄ နည်း တိုင်းပြီး ၄ ခါလုံး ပျက်ခဲ့ — [[ikki-eleven-references]])
    #    ⇒ ထည့်လျှင် 「ဂိတ် လျှော့」သာ ဖြစ်မည်。
    # ⚠️ ဂိတ်အတွင်း အမြင့်ဆုံး `1.5` ထားသည် — `sfxpol.POLICY["zae"]` ရဲ့
    #    ကိုယ်ပိုင် ကိန်း (playbook P3) နဲ့ တူညီသည်。 ယခင် ၀.၉ ထက် ၂ ဆ。
    # ⚠️ ဒါပေမယ့် `int(1.5 × 72.6/60) = 1` ⇒ ၇၂s ဗီဒီယိုမှာ **အခိုက် ၁ ခု**
    #    သာ ရဆဲ ဖြစ်သည် — ဂရပ်ဖစ် ၆ ခုမှာ ၅ ခု အသံ မရ。 ဖုံးအုပ်မှု
    #    အပြည့် လိုလျှင် ZAE အတွက် **တိုင်းချက် လိုအပ်**သည် (Zin ဆုံးဖြတ်ချက်)。
    sat=1.00, vign=0.0, cbal=False, sfx_per_min=1.5,
 ...
 "short-916": dict(label="Short Video", theme="ikki", fps=30, fmt="9:16",
    ...
    # cap_base 0.64 -> 0.78 -> 0.80 (2026-09-26 brief): measured caption centre was 0.60
